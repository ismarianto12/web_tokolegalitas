       ...
       <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
         ...
         <ul>
           <?php
            ...
            ?>
               <li>
                 <h5><i class="fa fa-bookmark-o"></i>&nbsp; <a href="#" onclick="singleArticleLoker(<?= $value->article_id . ',' . $value->article_category_id . ',' . $value->id_rumahsakit ?>)"><?= strip_tags($value->title) ?> </a></h5>
               </li>
           <?php
              }
            }
 ...
 <script>
   function singleArticleLoker(article_id, article_category_id, id_rumahsakit) {
     setTimeout(function() {
       $.ajax({
         url: base_url + 'front/single_article_loker',
         dataType: 'html',
         data: {
           a_id: article_id,
