...
?> 
<div id="program-wrapper" style="margin-top: 50px;"">
  <div id="program">
    <div id="breadcrumb">
      <div class="container">
        <div class="breadcrumb">
          <li><a href="index.html">Home</a></li>
          <li>Program Ungulan Nama Kantor</li>
          <form>
    ...
    <div class="aboutus">
      <div class="container">
          ...
          if($program){
            ...
            foreach ($program as $key => $value) {
             ...
             <div style="color:#444;margin-top:20px;" <?=$all?>><?=strip_tags(substr($value->content,0,300)).'....';?></div>
              <div <?=$all?>>
                <a  class="btn btn-primary btn-lg" required="required" href="<?=base_url();?><?=$rs?>/program/<?=$value->link?>" >Read More</a>
              </div>
        ...
        <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          ...
          <ul <?=$one?>>
            <h4>Program ungulan lainnya:</h4>
            <?php
            if($single_article_program){
              foreach ($single_article_program as $key => $value) {
                ?>
                <li><h5><i class="fa fa-bookmark-o"></i>&nbsp; <a href="<?=base_url();?><?=$rs?>/program/<?=$value->link?>" ><?=strip_tags($value->title)?>
                </a></h5></li>
                <?php
              }
            }
