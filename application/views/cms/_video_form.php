...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs pull-right">
        ...
        <li class="pull-left header"><i class="fa fa-file-text"></i> VIDEO </li>
        <div id="loading"></div>
    </ul>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select class="form-control"  name="category-input" id="category-input">
                            <?php
                            $cat = $this->model->getList(array('table' => 'article_category', 'where' => array('is_active' => 1,"article_category_id"=>4)));
                            if ($cat) {
                                foreach ($cat as $row) {
...
<script>
    $(document).ready(function () {
        ...
        $('#file_upload').on('filebatchuploadcomplete', function(event, files, extra) {
            loadContent(base_url + "view/_video_form/<?php echo $param;?>");
        });
    });

    function newForm() {
        loadContent(base_url + "view/_video_form", function () {
    ...
    function utilsArticle() {
        $("#table-video .editBtn").on("click",function() {
            loadContent(base_url + 'view/_video_form/' + $(this).attr('href').substring(1));
        });
