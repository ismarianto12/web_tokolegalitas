 jQuery.fn.extend({
     WAFloatBox: function () {
         ...
         a.prepend(`
        <div class="myk-btn">
            <img src="https://www.jqueryscript.net/demo/whatsapp-floatbox/images/wa-icon.png" class="myk-wa-icon">
        </div>
        ...
        <div class="myk-panelhead">
            <span class="myk-close">x</span>
                <img src="https://www.jqueryscript.net/demo/whatsapp-floatbox/images/wa-icon.png" class="myk-wa-icon" width="30px">
